...
**Audi (rilevante per questo progetto)**: `CAR_MAKE_AUDIO`=0x180000 **è "Audi"** (traslitterazione cinese "AUDIO", non l'impianto audio). L'**A5 è nel database**: `CAR_MODEL_OUDI_20_A5`=119603202, più `CAR_MODEL_XCARBUS_AUDI_COMPATIBLE`/`_AUDI_AUTO_AUX`, `RAISE_AUDIO_03_07_A4`/`_04_12_A3`/`_13_18_Q3`, `SIMPLE_AUDIO_A3/A4/TT`, `OUDI_05_11_AUDIO_A6`/`AUDIO_A3_A4`, `HIWORLD_AUDIO_A3/A4L`, `LUZHENG_AUDIO_A3`. I **flag funzione specifici Audi** stanno in `DriverAssistance` (120xxx): `AUDI_AIR_MODE`=120268, `AUDI_FUNCITON_ORIGIN_CAR_TYPE`=120298, `AUDI_STEER_WHELL_STAR_KEY_FUNCTION`=120267 (typo nei nomi originali). `VIN`/`CANBOX_VERSION` leggibili via `General` (10016/10004). `CarModel` è una **tabella di sole costanti** (nessun metodo).
