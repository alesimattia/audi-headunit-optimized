...
.method private createInfo(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    check-cast v12, Landroidx/lifecycle/OnLifecycleEvent;

    .line 125
    .local v12, "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    if-nez v12, :cond_4
    ...
    const-class v6, Landroidx/lifecycle/LifecycleOwner;
    ...
    :cond_6
    :goto_4
    invoke-interface {v12}, Landroidx/lifecycle/OnLifecycleEvent;->value()Landroidx/lifecycle/Lifecycle$Event;

    move-result-object v6

    .line 140
    .local v6, "event":Landroidx/lifecycle/Lifecycle$Event;
    array-length v15, v13
    ...
    .line 154
    new-instance v2, Landroidx/lifecycle/ClassesInfoCache$MethodReference;

    invoke-direct {v2, v14, v11}, Landroidx/lifecycle/ClassesInfoCache$MethodReference;-><init>(ILjava/lang/reflect/Method;)V

    .line 155
    .local v2, "methodReference":Landroidx/lifecycle/ClassesInfoCache$MethodReference;
    invoke-direct {v0, v3, v2, v6, v1}, Landroidx/lifecycle/ClassesInfoCache;->verifyAndPutHandler(Ljava/util/Map;Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V

    .line 123
    .end local v2    # "methodReference":Landroidx/lifecycle/ClassesInfoCache$MethodReference;
    .end local v6    # "event":Landroidx/lifecycle/Lifecycle$Event;
    .end local v11    # "method":Ljava/lang/reflect/Method;
    .end local v12    # "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    ...
    .line 152
    .restart local v6    # "event":Landroidx/lifecycle/Lifecycle$Event;
    .restart local v11    # "method":Ljava/lang/reflect/Method;
    .restart local v12    # "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    ...
    invoke-direct {v2, v3}, Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;-><init>(Ljava/util/Map;)V

    .line 158
    .local v2, "info":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    iget-object v6, v0, Landroidx/lifecycle/ClassesInfoCache;->mCallbackMap:Ljava/util/Map;

    invoke-interface {v6, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 159
    iget-object v6, v0, Landroidx/lifecycle/ClassesInfoCache;->mHasLifecycleMethods:Ljava/util/Map;
