...
# instance fields
.field private mAudioAttributesWrapper:Landroidx/media/AudioAttributesCompatApi21$Wrapper;
...
.method synthetic constructor <init>(Landroidx/media/AudioAttributesCompat$1;)V
    .locals 0
    .param p1, "x0"    # Landroidx/media/AudioAttributesCompat$1;
...
.method static synthetic access$202(Landroidx/media/AudioAttributesCompat;Landroidx/media/AudioAttributesCompatApi21$Wrapper;)Landroidx/media/AudioAttributesCompatApi21$Wrapper;
    .locals 0
    .param p0, "x0"    # Landroidx/media/AudioAttributesCompat;
    .param p1, "x1"    # Landroidx/media/AudioAttributesCompatApi21$Wrapper;

    .line 66
    iput-object p1, p0, Landroidx/media/AudioAttributesCompat;->mAudioAttributesWrapper:Landroidx/media/AudioAttributesCompatApi21$Wrapper;
...
.method static synthetic access$300(I)I
    ...
    .line 66
    invoke-static {p0}, Landroidx/media/AudioAttributesCompat;->usageForStreamType(I)I
...
.method public static fromBundle(Landroid/os/Bundle;)Landroidx/media/AudioAttributesCompat;
    ...
    .line 431
    .local v4, "attr":Landroidx/media/AudioAttributesCompat;
    ...
    .line 434
    const-string v5, "androidx.media.audio_attrs.LEGACY_STREAM_TYPE"
...
.method public static wrap(Ljava/lang/Object;)Landroidx/media/AudioAttributesCompat;
    ...
    .line 329
    .local v0, "aac":Landroidx/media/AudioAttributesCompat;
    move-object v1, p0

    check-cast v1, Landroid/media/AudioAttributes;

    .line 330
    invoke-static {v1}, Landroidx/media/AudioAttributesCompatApi21$Wrapper;->wrap(Landroid/media/AudioAttributes;)Landroidx/media/AudioAttributesCompatApi21$Wrapper;

    move-result-object v1

    iput-object v1, v0, Landroidx/media/AudioAttributesCompat;->mAudioAttributesWrapper:Landroidx/media/AudioAttributesCompatApi21$Wrapper;

    .line 331
    return-object v0

    .line 333
    .end local v0    # "aac":Landroidx/media/AudioAttributesCompat;
    :cond_0
    const/4 v0, 0x0
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroidx/media/AudioAttributesCompat;

    .line 826
    .local v2, "that":Landroidx/media/AudioAttributesCompat;
    ...
    sget-boolean v3, Landroidx/media/AudioAttributesCompat;->sForceLegacyBehavior:Z

    if-nez v3, :cond_2

    iget-object v3, p0, Landroidx/media/AudioAttributesCompat;->mAudioAttributesWrapper:Landroidx/media/AudioAttributesCompatApi21$Wrapper;
    ...
    .line 832
    :cond_2
    iget v3, p0, Landroidx/media/AudioAttributesCompat;->mContentType:I
    ...
    iget v3, p0, Landroidx/media/AudioAttributesCompat;->mFlags:I

    .line 833
    invoke-virtual {v2}, Landroidx/media/AudioAttributesCompat;->getFlags()I

    move-result v4

    if-ne v3, v4, :cond_4

    iget v3, p0, Landroidx/media/AudioAttributesCompat;->mUsage:I
    ...
    iget-object v3, p0, Landroidx/media/AudioAttributesCompat;->mLegacyStream:Ljava/lang/Integer;

    if-eqz v3, :cond_3

    iget-object v3, p0, Landroidx/media/AudioAttributesCompat;->mLegacyStream:Ljava/lang/Integer;

    iget-object v4, v2, Landroidx/media/AudioAttributesCompat;->mLegacyStream:Ljava/lang/Integer;
    ...
    :cond_3
    iget-object v3, v2, Landroidx/media/AudioAttributesCompat;->mLegacyStream:Ljava/lang/Integer;
    ...
    .line 822
    .end local v2    # "that":Landroidx/media/AudioAttributesCompat;
    :cond_5
    :goto_2
    return v1
.end method
...
.method public getContentType()I
    ...
    .line 349
    :cond_0
    iget v0, p0, Landroidx/media/AudioAttributesCompat;->mContentType:I
...
.method public getLegacyStreamType()I
    ...
    invoke-static {v0}, Landroidx/media/AudioAttributesCompatApi21;->toLegacyStreamType(Landroidx/media/AudioAttributesCompatApi21$Wrapper;)I
...
.method public getUsage()I
    ...
    .line 364
    :cond_0
    iget v0, p0, Landroidx/media/AudioAttributesCompat;->mUsage:I
...
.method public hashCode()I
    ...
    iget-object v2, p0, Landroidx/media/AudioAttributesCompat;->mLegacyStream:Ljava/lang/Integer;
