...
.method public getSubscribingBrowsers(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 274
    .local v0, "result":Ljava/util/List;, "Ljava/util/List<Landroidx/media/MediaSessionManager$RemoteUserInfo;>;"
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$MediaBrowserServiceImplBase;->this$0:Landroidx/media/MediaBrowserServiceCompat;
    ...
    iget-object v4, v3, Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;->subscriptions:Ljava/util/HashMap;
    ...
    .line 278
    .local v4, "callbackList":Ljava/util/List;, "Ljava/util/List<Landroidx/core/util/Pair<Landroid/os/IBinder;Landroid/os/Bundle;>;>;"
    if-eqz v4, :cond_0

    .line 279
    iget-object v5, v3, Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;->browserInfo:Landroidx/media/MediaSessionManager$RemoteUserInfo;

    invoke-interface {v0, v5}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 281
    .end local v2    # "binder":Landroid/os/IBinder;
    .end local v3    # "connection":Landroidx/media/MediaBrowserServiceCompat$ConnectionRecord;
    .end local v4    # "callbackList":Ljava/util/List;, "Ljava/util/List<Landroidx/core/util/Pair<Landroid/os/IBinder;Landroid/os/Bundle;>;>;"
    :cond_0
    goto :goto_0
