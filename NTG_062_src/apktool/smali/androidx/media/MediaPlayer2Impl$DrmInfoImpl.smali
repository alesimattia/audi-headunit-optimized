.class public final Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;
.super Landroidx/media/MediaPlayer2$DrmInfo;
...
.method private constructor <init>(Landroid/os/Parcel;)V
    ...
    .line 1822
    invoke-direct {p0}, Landroidx/media/MediaPlayer2$DrmInfo;-><init>()V
    ...
    invoke-direct {p0, v1}, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->arrToHex([B)Ljava/lang/String;
    ...
    .line 1830
    invoke-direct {p0, v1, v0}, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->parsePSSH([BI)Ljava/util/Map;

    move-result-object v2

    iput-object v2, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mMapPssh:Ljava/util/Map;
    ...
    iget-object v4, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mMapPssh:Ljava/util/Map;
    ...
    iput-object v3, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mSupportedSchemes:[Ljava/util/UUID;
    ...
    .line 1839
    iget-object v5, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mSupportedSchemes:[Ljava/util/UUID;

    invoke-direct {p0, v4}, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->bytesToUUID([B)Ljava/util/UUID;
    ...
    iget-object v7, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mSupportedSchemes:[Ljava/util/UUID;
...
.method private constructor <init>(Ljava/util/Map;[Ljava/util/UUID;)V
    ...
    .line 1818
    iput-object p1, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mMapPssh:Ljava/util/Map;

    .line 1819
    iput-object p2, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mSupportedSchemes:[Ljava/util/UUID;

    .line 1820
    return-void
.end method

.method synthetic constructor <init>(Ljava/util/Map;[Ljava/util/UUID;Landroidx/media/MediaPlayer2Impl$1;)V
    .locals 0
    .param p1, "x0"    # Ljava/util/Map;
    .param p2, "x1"    # [Ljava/util/UUID;
    .param p3, "x2"    # Landroidx/media/MediaPlayer2Impl$1;

    .line 1795
    invoke-direct {p0, p1, p2}, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;-><init>(Ljava/util/Map;[Ljava/util/UUID;)V
...
.method private makeCopy()Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;
    .locals 3

    .line 1850
    new-instance v0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;

    iget-object v1, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mMapPssh:Ljava/util/Map;

    iget-object v2, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mSupportedSchemes:[Ljava/util/UUID;

    invoke-direct {v0, v1, v2}, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;-><init>(Ljava/util/Map;[Ljava/util/UUID;)V
...
.method private parsePSSH([BI)Ljava/util/Map;
    ...
    .line 1890
    .local v13, "subset":[B
    invoke-direct {v0, v13}, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->bytesToUUID([B)Ljava/util/UUID;
    ...
    invoke-direct {v0, v10}, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->arrToHex([B)Ljava/lang/String;
...
.method public getPssh()Ljava/util/Map;
    ...
    .line 1804
    iget-object v0, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mMapPssh:Ljava/util/Map;
...
.method public getSupportedSchemes()Ljava/util/List;
    ...
    .line 1814
    iget-object v0, p0, Landroidx/media/MediaPlayer2Impl$DrmInfoImpl;->mSupportedSchemes:[Ljava/util/UUID;
