.class public final Landroidx/media/SessionCommandGroup2;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media/SessionCommandGroup2;->mCommands:Ljava/util/Set;

    .line 57
    return-void
.end method

.method public constructor <init>(Landroidx/media/SessionCommandGroup2;)V
    .locals 2
    .param p1, "other"    # Landroidx/media/SessionCommandGroup2;
    ...
    .line 66
    iget-object v0, p0, Landroidx/media/SessionCommandGroup2;->mCommands:Ljava/util/Set;

    iget-object v1, p1, Landroidx/media/SessionCommandGroup2;->mCommands:Ljava/util/Set;
...
.method private addCommandsWithPrefix(Ljava/lang/String;)V
    ...
    .line 115
    const-class v0, Landroidx/media/SessionCommand2;
    ...
    .line 121
    :try_start_0
    iget-object v2, p0, Landroidx/media/SessionCommandGroup2;->mCommands:Ljava/util/Set;

    new-instance v3, Landroidx/media/SessionCommand2;
    ...
    invoke-direct {v3, v4}, Landroidx/media/SessionCommand2;-><init>(I)V
...
.method public static fromBundle(Landroid/os/Bundle;)Landroidx/media/SessionCommandGroup2;
    .locals 6
    ...
    .line 221
    .local v0, "commandGroup":Landroidx/media/SessionCommandGroup2;
    const/4 v2, 0x0
    ...
    invoke-static {v4}, Landroidx/media/SessionCommand2;->fromBundle(Landroid/os/Bundle;)Landroidx/media/SessionCommand2;

    move-result-object v5

    .line 228
    .local v5, "command":Landroidx/media/SessionCommand2;
    if-eqz v5, :cond_3

    .line 229
    invoke-virtual {v0, v5}, Landroidx/media/SessionCommandGroup2;->addCommand(Landroidx/media/SessionCommand2;)V

    .line 221
    .end local v3    # "parcelable":Landroid/os/Parcelable;
    .end local v4    # "commandBundle":Landroid/os/Bundle;
    .end local v5    # "command":Landroidx/media/SessionCommand2;
    :cond_3
    :goto_1
...
.method addAllPlaybackCommands()V
    ...
    invoke-direct {p0, v0}, Landroidx/media/SessionCommandGroup2;->addCommandsWithPrefix(Ljava/lang/String;)V
...
.method public addCommand(I)V
    ...
    new-instance v1, Landroidx/media/SessionCommand2;

    invoke-direct {v1, p1}, Landroidx/media/SessionCommand2;-><init>(I)V
...
.method public addCommand(Landroidx/media/SessionCommand2;)V
    .locals 2
...
.method public getCommands()Ljava/util/Set;
    ...
    iget-object v1, p0, Landroidx/media/SessionCommandGroup2;->mCommands:Ljava/util/Set;
...
.method public hasCommand(I)Z
    ...
    check-cast v1, Landroidx/media/SessionCommand2;
...
.method public hasCommand(Landroidx/media/SessionCommand2;)Z
    .locals 2
    .param p1, "command"    # Landroidx/media/SessionCommand2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public removeCommand(Landroidx/media/SessionCommand2;)V
    .locals 2
    .param p1, "command"    # Landroidx/media/SessionCommand2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public toBundle()Landroid/os/Bundle;
    ...
    check-cast v2, Landroidx/media/SessionCommand2;

    .line 200
    .local v2, "command":Landroidx/media/SessionCommand2;
    ...
    .line 201
    .end local v2    # "command":Landroidx/media/SessionCommand2;
    goto :goto_0
