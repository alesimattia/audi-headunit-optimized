        ...
        switch (b) {
            ...
            case 1:
                if (args == null || !args.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                    throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + action + FileUtils.FILE_EXTENSION_SEPARATOR);
                }
                return;
            default:
                return;
        ...
        private static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            protected void onReceiveResult(int resultCode, Bundle resultData) {
                ...
                if (mediaControllerImpl != null && resultData != null) {
                    mediaControllerImpl.mExtraBinder = IMediaSession.Stub.asInterface(BundleCompat.getBinder(resultData, MediaSessionCompat.EXTRA_BINDER));
