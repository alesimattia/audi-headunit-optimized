...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    */
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & DataUtil.SERVICE_CMD_STOP_REMOTE_MONITOR;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & DataUtil.SERVICE_CMD_STOP_REMOTE_MONITOR;
        if (anchorHgrav != 1) {
            if (anchorHgrav != 5) {
    ...
    private static int resolveGravity(int gravity) {
        ...
        if ((gravity & DataUtil.SERVICE_CMD_STOP_REMOTE_MONITOR) == 0) {
            return gravity | 48;
        }
        return gravity;
    }
