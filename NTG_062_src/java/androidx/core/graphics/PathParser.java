    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                ...
                case 'H':
                case 'V':
                case DataUtil.SERVICE_CMD_CSI_REOPEN /* 104 */:
                case 'v':
                    incr = 1;
                    break;
                case 'L':
                case 'M':
                case 'T':
                case DataUtil.SERVICE_CMD_AVM_STATUS /* 108 */:
                case DataUtil.SERVICE_CMD_AVM_REVERSE_CHECK /* 109 */:
                case 't':
                    incr = 2;
                    break;
                case 'Q':
                case 'S':
                case DataUtil.SERVICE_CMD_BREAK /* 113 */:
                case 's':
                    incr = 4;
                    break;
                case 'Z':
