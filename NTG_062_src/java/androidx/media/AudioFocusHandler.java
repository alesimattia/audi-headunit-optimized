...
public class AudioFocusHandler {
    ...
    AudioFocusHandler(MediaSession2 session) {
        this.mImpl = new AudioFocusHandlerImplBase(session);
    }
    ...
    private static class AudioFocusHandlerImplBase implements AudioFocusHandlerImpl {
        ...
        AudioFocusHandlerImplBase(MediaSession2 session) {
            ...
            this.mAudioManager = (AudioManager) this.mSession.getContext().getSystemService("audio");
        }
        ...
        @Override // androidx.media.AudioFocusHandler.AudioFocusHandlerImpl
        public boolean onPlayRequested() {
