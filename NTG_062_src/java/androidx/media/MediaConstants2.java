...
class MediaConstants2 {
    ...
    static final String ARGUMENT_ICONTROLLER_CALLBACK = "androidx.media.argument.ICONTROLLER_CALLBACK";
    ...
    static final String ARGUMENT_PLAYBACK_STATE_COMPAT = "androidx.media.argument.PLAYBACK_STATE_COMPAT";
    ...
    static final String CONTROLLER_COMMAND_BY_COMMAND_CODE = "androidx.media.controller.command.BY_COMMAND_CODE";
    static final String CONTROLLER_COMMAND_BY_CUSTOM_COMMAND = "androidx.media.controller.command.BY_CUSTOM_COMMAND";
    static final String CONTROLLER_COMMAND_CONNECT = "androidx.media.controller.command.CONNECT";
    static final String CONTROLLER_COMMAND_DISCONNECT = "androidx.media.controller.command.DISCONNECT";
    static final String ROOT_EXTRA_DEFAULT = "androidx.media.root_default_root";
    static final String SESSION_EVENT_ON_ALLOWED_COMMANDS_CHANGED = "androidx.media.session.event.ON_ALLOWED_COMMANDS_CHANGED";
    static final String SESSION_EVENT_ON_BUFFERING_STATE_CHANGED = "androidx.media.session.event.ON_BUFFERING_STATE_CHANGED";
    static final String SESSION_EVENT_ON_CHILDREN_CHANGED = "androidx.media.session.event.ON_CHILDREN_CHANGED";
    static final String SESSION_EVENT_ON_CURRENT_MEDIA_ITEM_CHANGED = "androidx.media.session.event.ON_CURRENT_MEDIA_ITEM_CHANGED";
    static final String SESSION_EVENT_ON_ERROR = "androidx.media.session.event.ON_ERROR";
    static final String SESSION_EVENT_ON_PLAYBACK_INFO_CHANGED = "androidx.media.session.event.ON_PLAYBACK_INFO_CHANGED";
    static final String SESSION_EVENT_ON_PLAYBACK_SPEED_CHANGED = "androidx.media.session.event.ON_PLAYBACK_SPEED_CHANGED";
    static final String SESSION_EVENT_ON_PLAYER_STATE_CHANGED = "androidx.media.session.event.ON_PLAYER_STATE_CHANGED";
    static final String SESSION_EVENT_ON_PLAYLIST_CHANGED = "androidx.media.session.event.ON_PLAYLIST_CHANGED";
    static final String SESSION_EVENT_ON_PLAYLIST_METADATA_CHANGED = "androidx.media.session.event.ON_PLAYLIST_METADATA_CHANGED";
    static final String SESSION_EVENT_ON_REPEAT_MODE_CHANGED = "androidx.media.session.event.ON_REPEAT_MODE_CHANGED";
    static final String SESSION_EVENT_ON_ROUTES_INFO_CHANGED = "androidx.media.session.event.ON_ROUTES_INFO_CHANGED";
    static final String SESSION_EVENT_ON_SEARCH_RESULT_CHANGED = "androidx.media.session.event.ON_SEARCH_RESULT_CHANGED";
    static final String SESSION_EVENT_ON_SEEK_COMPLETED = "androidx.media.session.event.ON_SEEK_COMPLETED";
    static final String SESSION_EVENT_ON_SHUFFLE_MODE_CHANGED = "androidx.media.session.event.ON_SHUFFLE_MODE_CHANGED";
    static final String SESSION_EVENT_SEND_CUSTOM_COMMAND = "androidx.media.session.event.SEND_CUSTOM_COMMAND";
    static final String SESSION_EVENT_SET_CUSTOM_LAYOUT = "androidx.media.session.event.SET_CUSTOM_LAYOUT";
