...
public class SubtitleController {
    ...
    public SubtitleController(Context context, MediaTimeProvider timeProvider, Listener listener) {
        ...
        this.mCallback = new Handler.Callback() { // from class: androidx.media.subtitle.SubtitleController.1
        ...
        this.mCaptioningChangeListener = new CaptioningManager.CaptioningChangeListener() { // from class: androidx.media.subtitle.SubtitleController.2
