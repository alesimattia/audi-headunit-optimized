...
import androidx.media.subtitle.MediaTimeProvider;
...
public abstract class SubtitleTrack implements MediaTimeProvider.OnMediaTimeListener {
    ...
    @Override // androidx.media.subtitle.MediaTimeProvider.OnMediaTimeListener
    ...
    protected synchronized boolean addCue(Cue cue) {
        ...
        if (this.mVisible && cue.mStartTimeMs <= nowMs && cue.mEndTimeMs >= this.mLastTimeMs) {
            ...
            this.mRunnable = new Runnable() { // from class: androidx.media.subtitle.SubtitleTrack.1
    ...
    static class CueList {
        ...
        public Iterable<Pair<Long, Cue>> entriesBetween(final long lastTimeMs, final long timeMs) {
            return new Iterable<Pair<Long, Cue>>() { // from class: androidx.media.subtitle.SubtitleTrack.CueList.1
