...
public interface ILocationListener extends IInterface {
    void onGpsStatusChange(boolean z, boolean z2) throws RemoteException;

    void onLocationChange(LocationBean locationBean) throws RemoteException;

    public static abstract class Stub extends Binder implements ILocationListener {
        private static final String DESCRIPTOR = "com.tencent.taes.remote.api.location.listener.ILocationListener";
        static final int TRANSACTION_onGpsStatusChange = 2;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    onGpsStatusChange(_arg02, _arg1);
                    reply.writeNoException();
                    return true;
                default:
